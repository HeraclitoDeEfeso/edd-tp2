class BTree(object):
    ...
    def insertar(self, nueva_key, documento=None):
        """Inserta un key con un valor determinado"""
        if not self.buscar(nueva_key, documento):
    ...
    def buscar(self, valor, nodo=None, documento=None):
        ...
        if valor in nodo.keys:
            if documento != None:
                #agrego el documento a su lista de aparicion
                """la lista de aparicion no esta implementada aun"""
            return True
